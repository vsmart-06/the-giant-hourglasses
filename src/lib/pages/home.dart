...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  void initializePoints() async {
    var response = await get(
        Uri.parse("https://the-giant-hourglasses.vercel.app/get-points"));
    setState(() {
  ...
  void stopListening() async {
    ...
    var response = await post(
        Uri.parse("https://the-giant-hourglasses.vercel.app/change-points"),
                    ...
                    Row(
                      ...
                      children: [
                        HouseCard(
                            house: "Gryffindor",
                            points:
                                (points == null) ? 0 : points["gryffindor"]!,
                        ...
                        HouseCard(
                            house: "Hufflepuff",
                            points:
                                (points == null) ? 0 : points["hufflepuff"]!,
          ...
          Scaffold(
            ...
            body: Stack(
              children: [
                Center(
                  child: Image(
                    image: NetworkImage("https://i.imgur.com/DjbgAJ5.png"),
                    opacity: AlwaysStoppedAnimation(0.3),
                    fit: BoxFit.cover,
                  ),
                ),
